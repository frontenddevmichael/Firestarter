...
<p style="margin:8px 0"><strong style="color:#555">Email:</strong> <span style="font-family:monospace;background:#f5f5f5;padding:2px 8px;border-radius:4px">${judge_email}</span></p>
<p style="margin:8px 0"><strong style="color:#555">Password:</strong> <span style="font-family:monospace;background:#f5f5f5;padding:2px 8px;border-radius:4px">${judge_password}</span></p>
</div>
