...
const schemas = {
  ...
  '/prize/how-to-enter': {
    ...
    description: 'Two stages to enter: write your poem and Voice Reflection, then perform if shortlisted.',
    url: `${url}/prize/how-to-enter`,
    step: [
      { '@type': 'HowToStep', name: 'Write the Poem', text: 'One original poem on the 2026 theme, up to 40 lines.' },
      { '@type': 'HowToStep', name: 'Voice Reflection', text: 'Three to five sentences on what your poem is really about and why you wrote it.' },
    ],
  },
  '/prize/key-dates': {
    '@context': 'https://schema.org',
    ...
    description: 'Competition timeline: entries close October 30, 2026. Grand Final in December.',
  ...
  '/prize/enter': {
    ...
    description: 'Enter the Firestarter Young Poets Prize. Submit your poem and Voice Reflection.',
    url: `${url}/prize/enter`,
  },
  ...
  '/prize/contact': {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'What do I need to submit?', acceptedAnswer: { '@type': 'Answer', text: 'One original poem (up to 40 lines) and a short Voice Reflection (three to five sentences). Performance videos are only needed if you are shortlisted.' } },
      { '@type': 'Question', name: 'Is there an entry fee?', acceptedAnswer: { '@type': 'Answer', text: 'No. Entry is free, and payment is never requested at any stage.' } },
